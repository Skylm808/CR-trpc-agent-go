...
| [eval-matrix.md](eval-matrix.md) | 公开 fixture、self-contained holdout matrix 和外部 hidden matrix 输入契约 |
...
4. [eval-matrix.md](eval-matrix.md) — public / holdout / external hidden matrix 注入和评测口径
